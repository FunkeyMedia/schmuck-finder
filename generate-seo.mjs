...
const journalCards=articles.map((a,i)=>`<article class="journal-card"><a href="/ratgeber/${a[0]}/"><span class="editorial-media"><img src="${editorial[i%editorial.length]}" alt="Redaktionelles Schmuckmotiv" loading="lazy" width="640" height="800"><small class="ai-badge">KI-Bild</small></span><span>${esc(a[2])} · ${esc(a[3])}</span><h2>${esc(a[1])}</h2><p>${esc(a[4])}</p></a></article>`).join('');
